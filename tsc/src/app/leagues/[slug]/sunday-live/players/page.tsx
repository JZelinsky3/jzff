// Full leaderboard — top performers per position + bench/duds, expanded beyond
// the bottom ticker's first 10.
...
import { PlayersBoard } from '../_components/sub/PlayersBoard'
...
export default async function Page({
  ...
  return (
    <SlShell meta={access.meta} liveQuality={result.league.league.liveQuality}>
      <PlayersBoard slug={slug} initial={result.league} initialDemo={demo} />
    </SlShell>
  )
}
