...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Four tiers. Rookie at $3/month or $15/year for 1 league. Veteran at $5/month or $25/year for up to 3 leagues. All-Pro at $12/month or $50/year for up to 7 leagues. HOF at $25/month or $100/year for up to 15 leagues. Every plan has a 10-day free trial; one trial per user lifetime.",
      },
    },
    {
      "@type": "Question",
    ...
    <main>
      ...
      <div className="section">
        <div className="section-header">
          ...
          <span className="section-title">Four tiers —</span>
        ...
        <FaqItem q="How much does it cost?">
          ...
          <strong>All-Pro</strong> — $12/mo or $50/yr, archive up to 7 leagues.{" "}
          <strong>HOF</strong> — $25/mo or $100/yr, archive up to 15 leagues. Every
