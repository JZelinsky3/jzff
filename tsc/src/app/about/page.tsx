...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Three tiers. Rookie at $5/month or $30/year for 1 league. Veteran at $15/month or $75/year for up to 5 leagues. Legend at $25/month or $100/year for unlimited leagues. Every plan has a 10-day free trial; one trial per user lifetime.",
      },
    },
    {
      "@type": "Question",
    ...
    <main>
      ...
      <div className="section">
        ...
        <FaqItem q="How much does it cost?">
          <strong>Rookie</strong> — $5/mo or $30/yr, archive 1 league.{" "}
          <strong>Veteran</strong> — $15/mo or $75/yr, archive up to 5 leagues.{" "}
          <strong>Legend</strong> — $25/mo or $100/yr, archive unlimited leagues. Every
