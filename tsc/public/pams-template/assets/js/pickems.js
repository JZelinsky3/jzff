...
// and submit layers are swapped — data comes from /leagues/<slug>/pickems/data,
...
(function () {
  ...
  // ── Boot ──────────────────────────────────────────────────────────────────
  async function boot() {
    var res = await fetch('pickems/data', { cache: 'no-store' });
  ...
  async function onSubmitPicks() {
    ...
    try {
      var res = await fetch('pickems/submit', {
        method: 'POST',
